...
strongly admissible semantics semantics.
...
-----------------  Credulous reasoning  -----------------------
Call:
echo ":- not in("<arg>")." | cat - <af.apx> | clingo - str_adm.lp
...
-----------------  Skeptical reasoning  -----------------------
This problem is trivially false (as the empty set is strongly admissible, no
argument is in every strongly admissible set).



--------------------  Enumerate all  --------------------------
clingo str_adm.lp <af.apx> 0

Returns:
One extension per line; the arguments in the extension are labelled "in"

--------------------  Enumerate some  -------------------------
clingo str_adm.lp <af.apx> 1

Returns:
One extension per line; the arguments in the extension are labelled "in"

-----------------------  Counting  ----------------------------
clingo -q str_adm.lp <af.apx> 0
