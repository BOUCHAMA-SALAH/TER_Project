...
-----------------  Credulous reasoning  -----------------------
Call:
echo ":- not in("<arg>")." | cat - <af.apx> | clingo --heuristic=Domain --enum=domRec --out-hide - preferred.lp
...
-----------------  Skeptical reasoning  -----------------------
Call:
echo ":- in("<arg>")." | cat - <af.apx> | clingo --heuristic=Domain --enum=domRec --out-hide - preferred.lp
...
--------------------  Enumerate all  --------------------------
clingo --heuristic=Domain --enum=domRec --out-hide preferred.lp <af.apx> 0

Returns:
One extension per line; the arguments in the extension are labelled "in"

--------------------  Enumerate some  -------------------------
clingo --heuristic=Domain --enum=domRec --out-hide preferred.lp <af.apx> 1

Returns:
One extension per line; the arguments in the extension are labelled "in"

-----------------------  Counting  ----------------------------
clingo -q --heuristic=Domain --enum=domRec --out-hide preferred.lp <af.apx> 0
