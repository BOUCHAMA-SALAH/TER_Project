...
-----------------  Credulous reasoning  -----------------------
Call:
echo ":- not in("<arg>")." | cat - <af.apx> | clingo - naive.dl
...
-----------------  Skeptical reasoning  -----------------------
Call:
echo ":- in("<arg>")." | cat - <af.apx> | clingo - naive.dl
...
--------------------  Enumerate all  --------------------------
clingo naive.dl <af.apx> 0

Returns:
One extension per line; the arguments in the extension are labelled "in"

--------------------  Enumerate some  -------------------------
clingo naive.dl <af.apx> 1

Returns:
One extension per line; the arguments in the extension are labelled "in"

-----------------------  Counting  ----------------------------
clingo -q naive.dl <af.apx> 0
