...
-----------------  Skeptical reasoning  -----------------------
Call:
bash stage_skept.sh <af.apx> <arg>
...
--------------------  Enumerate all  --------------------------
bash stage_enum.sh <af.apx>

Returns:
One extension per line

--------------------  Enumerate some  -------------------------
clingo --heuristic=domain --enum=domRec --out-hide <af.apx> stage_some_extension.lp 1

Returns:
One extension; the arguments in the extension are labelled "in"

-----------------------  Counting  ----------------------------
bash stage_count.sh <af.apx> 
